/*
 *   Battery_Sfcn_mex.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        void BatteryMeasure_step(single y1[1])
 *
 *   Simulink version           : 8.7 (R2016a) 10-Feb-2016
 *   C source code generated on : 18-Sep-2019 16:02:23
...
/*
   ...
   def.SourceFiles = {'BatteryMeasure_Wrapper.c'};
 ...
 */
#define S_FUNCTION_NAME                Battery_Sfcn_mex
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "BatteryMeasure_start", MDL_INFO_ID_RESERVED, 0, 0,
                 ssGetPath(S));

    /*
     * Register reserved identifier for OutputFcnSpec
     */
    ssRegMdlInfo(S, "BatteryMeasure_step", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath
                 (S));

    /*
     * Register reserved identifier for TerminateFcnSpec
     */
    ssRegMdlInfo(S, "BatteryMeasure_term", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath
                 (S));
  }
