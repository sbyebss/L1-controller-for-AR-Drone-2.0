/*
 *   AR_Drone_Bottom_Camera.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        videoGrabImage2(uint8 y1[153600])
 *
 *   Simulink version           : 8.7 (R2016a) 10-Feb-2016
 *   C source code generated on : 18-Sep-2019 16:01:49
...
/*
   ...
   def.SFunctionName = 'AR_Drone_Bottom_Camera';
   def.OutputFcnSpec = 'videoGrabImage2(uint8 y1[153600])';
 ...
 */
#define S_FUNCTION_NAME                AR_Drone_Bottom_Camera
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "videoGrabImage2", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
