...
%   MATLAB file generated on : 18-Sep-2019 16:02:02
...
% Dependency info for S-function 'AR_Drone_Front_Camera'
info(1).SFunctionName = 'AR_Drone_Front_Camera';
info(1).IncPaths = {'F:\I_am_smart\AR_drone\SimulinkARDroneTarget-R2016_ab\AR_Drone_Target\blocks\videolib', '.'};
info(1).SrcPaths = {'F:\I_am_smart\AR_drone\SimulinkARDroneTarget-R2016_ab\AR_Drone_Target\blocks\videolib', '.'};
info(1).SourceFiles = {'video.c'};
info(1).Language = 'C';
% Dependency info for S-function 'AR_Drone_Bottom_Camera'
info(2).SFunctionName = 'AR_Drone_Bottom_Camera';
info(2).IncPaths = {'F:\I_am_smart\AR_drone\SimulinkARDroneTarget-R2016_ab\AR_Drone_Target\blocks\videolib', '.'};
info(2).SrcPaths = {'F:\I_am_smart\AR_drone\SimulinkARDroneTarget-R2016_ab\AR_Drone_Target\blocks\videolib', '.'};
