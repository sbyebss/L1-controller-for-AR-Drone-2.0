/*
 *   AR_Drone_Front_Camera.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        videoGrabImage1(uint8 y1[1843200])
 *
 *   Simulink version           : 8.7 (R2016a) 10-Feb-2016
 *   C source code generated on : 18-Sep-2019 16:01:48
...
/*
   ...
   def.SFunctionName = 'AR_Drone_Front_Camera';
   def.OutputFcnSpec = 'videoGrabImage1(uint8 y1[1843200])';
   def.StartFcnSpec = 'void videoInit1(void)';
   def.TerminateFcnSpec = 'void videoClose1(void)';
 ...
 */
#define S_FUNCTION_NAME                AR_Drone_Front_Camera
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetOutputPortWidth(S, 0, 1843200);
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "videoInit1", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

    /*
     * Register reserved identifier for OutputFcnSpec
     */
    ssRegMdlInfo(S, "videoGrabImage1", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

    /*
     * Register reserved identifier for TerminateFcnSpec
     */
    ssRegMdlInfo(S, "videoClose1", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
